...
// // void CircuitOptimizer::GateFusion(std::unique_ptr<QuantumComputation> &&qc,
// //  std::vector<FusedGate>& fused3,
// //  std::unique_ptr<dd::Package<dd::DDPackageConfig>>&&    dd,
// //  size_t nDim) 

// // int CircuitOptimizer::MaxELLRowGPU(dd::mEdge fused_edge,
// //  std::unique_ptr<dd::Package<dd::DDPackageConfig>>&&    dd,
// //  size_t nDim)
// // void CircuitOptimizer::PermutationFusion(QuantumComputation& qc)
