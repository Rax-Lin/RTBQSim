...
u3(pi*1.0,0,pi*1.0) q[1];
u3(pi*1.0,0,pi*1.0) q[2];
rx(pi*0.5) q[1];
cx q[1],q[2];
...
u3(pi*0.3237918088,pi*1.5,pi*0.5) q[5];
...
rz(pi*0.5) q[6];
cx q[5],q[6];
u3(pi*0.3237918088,pi*0.5,pi*1.5) q[5];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[6];
u3(pi*0.5,pi*1.5,0) q[5];
u3(pi*0.5,pi*1.5,pi*1.0) q[6];
rx(pi*0.5) q[5];
cx q[5],q[6];
rx(pi*0.013312485) q[5];
ry(pi*0.5) q[6];
...
u3(pi*0.0204107577,pi*1.5,pi*1.5) q[4];
u3(pi*0.0204107577,pi*0.5,pi*1.5) q[5];
rx(pi*0.5) q[4];
cx q[4],q[5];
...
cx q[4],q[5];
u3(pi*0.0204107577,pi*1.5,pi*1.5) q[4];
u3(pi*0.0204107577,pi*1.5,pi*0.5) q[5];
u3(pi*0.75,pi*0.5,pi*1.0) q[4];
u3(pi*0.75,pi*1.5,pi*1.0) q[5];
rx(pi*0.5) q[4];
cx q[4],q[5];
rx(pi*0.0181217245) q[4];
ry(pi*0.5) q[5];
...
rz(pi*0.5) q[5];
cx q[4],q[5];
u3(pi*0.75,pi*2.0,pi*0.5) q[4];
u3(pi*0.75,0,pi*1.5) q[5];
...
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[6];
u3(pi*0.6762081912,pi*1.5,pi*1.5) q[7];
rx(pi*0.5) q[6];
cx q[6],q[7];
...
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[7];
u3(pi*0.5,pi*0.5,0) q[6];
u3(pi*0.5,pi*1.5,pi*1.0) q[7];
rx(pi*0.5) q[6];
cx q[6],q[7];
rx(pi*0.0044947321) q[6];
ry(pi*0.5) q[7];
...
u3(pi*0.541537658,pi*1.5,pi*0.5) q[10];
u3(pi*0.458462342,pi*1.5,pi*1.5) q[11];
rx(pi*0.5) q[10];
cx q[10],q[11];
...
rz(pi*0.5) q[11];
cx q[10],q[11];
u3(pi*0.541537658,pi*0.5,pi*1.5) q[10];
u3(pi*0.458462342,pi*1.5,pi*1.5) q[11];
u3(pi*0.3071037501,pi*0.5,pi*1.0) q[10];
u3(pi*0.3071037501,pi*1.5,pi*1.0) q[11];
rx(pi*0.5) q[10];
cx q[10],q[11];
rx(pi*0.0354803847) q[10];
ry(pi*0.5) q[11];
...
rz(pi*0.5) q[11];
cx q[10],q[11];
u3(pi*0.3071037501,0,pi*0.5) q[10];
u3(pi*0.3071037501,pi*2.0,pi*1.5) q[11];
...
u3(pi*0.1762081912,pi*0.5,pi*1.5) q[2];
u3(pi*0.1762081912,pi*1.5,pi*0.5) q[6];
rx(pi*0.5) q[2];
cx q[2],q[6];
...
rz(pi*0.5) q[6];
cx q[2],q[6];
u3(pi*0.8237918088,pi*0.5,pi*1.5) q[2];
u3(pi*0.8237918088,pi*1.5,pi*0.5) q[6];
u3(pi*0.5,pi*0.5,0) q[2];
u3(pi*0.5,pi*0.5,0) q[6];
rx(pi*0.5) q[2];
cx q[2],q[6];
rx(pi*0.0104580358) q[2];
...
u3(pi*0.3237918088,pi*1.5,pi*1.5) q[3];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[7];
rx(pi*0.5) q[3];
cx q[3],q[7];
...
u3(pi*0.6762081912,pi*1.5,pi*1.5) q[7];
u3(pi*0.5,pi*0.5,0) q[3];
u3(pi*0.5,pi*0.5,0) q[7];
rx(pi*0.5) q[3];
cx q[3],q[7];
rx(pi*0.0143994165) q[3];
ry(pi*0.5) q[7];
